...
description: SSMS Solution Explorer provides containers called projects for managing items such as database scripts, queries, data connections, and files.
author: rwestMSFT
...
The items contained in projects depend on the project type and whether you're using SQL Server Management Studio.

## Related tasks

Use the following articles to get started with SQL Server Solutions:
