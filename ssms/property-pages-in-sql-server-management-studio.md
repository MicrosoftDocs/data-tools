...
description: Learn about property page dialog boxes in SQL Server Management Studio (SSMS).
author: rwestMSFT
...
Property page dialog boxes in SQL Server Management Studio (SSMS) all use a common format, displaying information with expanding and collapsing categories. The fields shown depend on the particular property. Properties shown in gray are read-only. **Categorized** and **Alphabetic** buttons are near the top of each property page.
