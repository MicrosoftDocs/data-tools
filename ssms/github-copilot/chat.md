...
1. You can promote your inline chat thread to the chat window by selecting **View in chat window**. Promoting the chat to the window preserves the record and context of your conversation, and you can continue in the chat window.
...
Copilot Chat can generate [Mermaid diagrams](https://mermaid.js.org/intro/#diagram-types), including entity relationships, flowcharts, Gantt, and more. You can then visualize complex relationships and workflows directly in the editor.
