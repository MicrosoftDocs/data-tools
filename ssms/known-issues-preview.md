...
| Import/Export | The Import and Export capabilities aren't available. They will be available in a later preview. | Use SSMS 21 for importing and exporting data. |
...
| Maintenance Plans | Creating and modifying Maintenance Plans isn't available. This feature will be available in a later preview. | Use SSMS 21 for creating and modifying Maintenance Plans. |
...
| SQL Server Integration Services (SSIS) | Support for legacy [Integration Services service](/sql/integration-services/service/integration-services-service-ssis-service#manage-the-service) isn't available for SQL Server 2025.| To manage the legacy Integration Services Service for SQL Server 2025, use SSMS 21.|
