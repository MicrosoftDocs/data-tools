...
| Connection | You can't import connections from a previous version. This issue will be resolved in a later release. | There is no workaround for SSMS versions 20 and older. A workaround for importing connections from SSMS 21 to SSMS 22 can be found [here](https://vladdba.com/2025/11/17/import-saved-connections-from-ssms-21-to-ssms-22/).|
...
| GitHub Copilot in SSMS | After updating to SSMS 22.5 from an earlier release, the **Active Document** isn't selected by default if it had been previously. | Select **Auto-attach active document** to enable this capability. |
...
| GitHub Copilot in SSMS | GPT-5* models might produce errors or don't respond. | Don't use, or switch to, GPT-5* models. |
