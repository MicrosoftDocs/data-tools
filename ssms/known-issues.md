...
| Analysis Services | When adding Azure Analysis Services administrators through **Server Properties** > **Security**, the **Search by name or email address** feature might not return results. | Add users with the **Manual Entry** option. |
