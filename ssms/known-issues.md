...
| Connection | You can't import connections from a previous version. This issue will be resolved in a later release. | There is no workaround for SSMS versions 20 and older. A [workaround for importing connections from SSMS 21 to SSMS 22](https://vladdba.com/2025/11/17/import-saved-connections-from-ssms-21-to-ssms-22/) can be found.|
