...
| GitHub Copilot in SSMS | Changing models doesn't persist across threads or restarts of SSMS. | You can change the model if you desire, after opening SSMS or creating a new thread. |
