...
description: Specify a job that you want to run, and to obtain a list of operators to be notified, in response to a SQL Server Agent alert.
author: rwestMSFT
...
# SQL Server Agent alert properties - New Alert (Response page)

[!INCLUDE [SQL Server SQL MI](../includes/applies-to-version/sql-asdbmi.md)]

[!INCLUDE [sql-server-agent-azure-sql-managed-instance-support](../includes/sql-server-agent-azure-sql-managed-instance-support.md)]

Use this page to specify a job that you want to run and to obtain a list of operators to be notified in response to a [!INCLUDE [ssNoVersion](../includes/ssnoversion-md.md)] Agent alert.
...
Lists the operators to notify when an alert occurs. To specify a notification method, select the **E-mail**, **Pager**, or **Net send** check box that is displayed after the operator name.

This option is only available when **Notify operators** is selected.
