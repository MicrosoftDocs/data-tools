---
title: "Release Notes for SQL Server Management Studio (SSMS) 21"
description: Release notes for SQL Server Management Studio (SSMS) 21.
...
# Release notes for SQL Server Management Studio (SSMS) 21

[!INCLUDE [sql-asdb-asdbmi-asa](includes/applies-to-version/sql-asdb-asdbmi-asa.md)]

This article details updates, improvements, and bug fixes for [!INCLUDE [ssms-21-md](includes/ssms-21-md.md)].
...
| Connection | Added **Close Idle SQL Connections** command under the Help menu. For more information, see [Connection pooling in SQL Server Management Studio](connection-pooling-sql-server-management-studio.md). |
...
| Copilot in SSMS (Preview) | Added Copilot in SQL Server Management Studio (Preview) available from the AI Assistance workload in the Visual Studio Installer. |
