...
## View parameter info for functions or stored procedures
...
1. As you type the parameters, the bold font changes to reflect the next parameter that you need to enter.

1. Press **Esc** at any time to close the list, or continue typing until you complete the function.

   For a function, if you type the closing parenthesis you also close the parameter list.

## Manually start parameter info

1. On the **Edit** menu, select **IntelliSense** and then select **Parameter Info**.

1. Press the **Ctrl**+**Shift**+**Space** keyboard shortcut.
