...
1. Launch the snippet picker tooltip in one of three ways:

   - Press **Ctrl**+**K**, **Ctrl**+**X**.
   - On the **Edit** menu, point to **IntelliSense**, then select **Insert Snippet**.
   - Right-click the mouse and then select the **Insert Snippet** command from the shortcut menu.

1. Double-click the snippet, or select the snippet from the snippet picker and then press **Tab** or **Enter**.
