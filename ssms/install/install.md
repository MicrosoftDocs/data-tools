...
description: Learn how to use Visual Studio Installer to install SQL Server Management Studio (SSMS). Use SSMS to configure and manage your database engine.
